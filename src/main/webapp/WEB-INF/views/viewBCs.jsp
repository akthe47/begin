                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">This is sample of text field</span>
                                               ...
                                               <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Numero Bon de Commande</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <c:choose>
							<c:when test="${type==1}">
                                                        <input type="text" class="form-control"  disabled="true" value="${contrat.numbc}"/>
                                                        </c:when>
							<c:otherwise>
                                                            <form:input path="numbc" id="numbc" class="form-control" />
                                                        </c:otherwise>
                                                </c:choose>    
							...
							<c:otherwise>
                                            ...
                                            <span class="help-block"><div class="has-error">
                                                ...
                                                <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Timbre</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <c:choose>
							<c:when test="${type==1}">
                                                        <input type="text" class="form-control"  disabled="true" value="${contrat.timbre}"/>
                                                        </c:when>
							<c:otherwise>
                                                            <form:input path="timbre" id="timbre" class="form-control" />
                                                        </c:otherwise>
                                                </c:choose>    
                                ...
                                <div class="panel-footer">
                                    <a href="<c:url value="/listbc-${p}"/>" class="btn btn-default">Retour</a>
                                    <c:if test="${type!=1}">
