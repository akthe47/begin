                        ...
                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            ...
                                            <span class="help-block">This is sample of text field</span>
                                               ...
                                               <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Numero facture</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <c:choose>
							<c:when test="${type==1}">
                                                        <input type="text" class="form-control"  disabled="true" value="${contrat.numfacture}"/>
                                                        </c:when>
							<c:otherwise>
                                                            <form:input path="numfacture" id="numfacture" class="form-control" />
                                                        </c:otherwise>
                                                </c:choose>    
							...
							<c:otherwise>
                                ...
                                <div class="panel-footer">
                                    <a href="<c:url value="/list-f-${p}"/>" class="btn btn-default">Retour</a>       
                                    <c:if test="${type!=1}">
...
function calcule_ht_ttc(event) // fonction de calcul
{
	...
	var prix_ttc = $('input[name="mttc"]').val();
	
	if(event.target.name=='mttc')
	{
	...
	else
	{
		...
		$('input[name="mttc"]').val(new_prix_ttc);
	}	
}
