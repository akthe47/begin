		...
		<div class="well lead">Formulaire Utilisateur</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			<form:input type="hidden" path="id" id="id"/>
				...
				<div class="form-group">
					<label class="col-md-3 control-lable" for="ssoId">Pseudo</label>
					<div class="col-md-7">
						<c:choose>
							<c:when test="${edit}">
				...
				<div class="form-actions floatRight">
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Completer Edition" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/list' />">Retour</a>
						</c:when>
						<c:otherwise>
							<input type="submit" value="Ajouter" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/list' />">Retour</a>
						</c:otherwise>
					</c:choose>
				</div>
